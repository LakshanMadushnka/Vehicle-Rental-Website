      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="brand" name="brand" placeholder="Vehicle Brand " required autofocus="">
          </div>


          <div class="form-group">
            <input type="text" class="form-control" id="car_name" name="car_name" placeholder="Vehicle Model " required autofocus="">
          </div>
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="city" name="city" placeholder="City " required autofocus="">
          </div>
...
<div style="overflow-x:auto;">
  ...
  <tbody>
    <tr>
      ...
      <td>
                                    <a class='btn btn-primary btn-sm' href='edit_car.php?car_id=<?php echo $row["car_id"]; ?>'>Edit</a>
                                    <a class='btn btn-primary btn-sm' style='background-color:red; border:none' href='deleteCar.php?car_id=<?php echo $row["car_id"]; ?>'>Delete</a>
