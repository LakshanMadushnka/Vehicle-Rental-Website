...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <img style="width: 100%;" class="card-img-top" src="<?php echo $car_img; ?>" alt="Card image cap">
          <!-- <div class="form-group"> -->
          
          <h5> Brand:&nbsp;  <b><?php echo($car_brand);?></b></h5>
              <h5> Vehicle Model:&nbsp;  <b><?php echo($car_name);?></b></h5>
         <!-- </div> -->
