...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
  ...
  .submit-button {
    ...
    <?php
        ...
        // No cars found based on the search criteria
        echo "<p>No cars available matching your search criteria.</p>";
    }
    ?>
...
<br>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&callback=myMap" type="text/javascript"></script>
